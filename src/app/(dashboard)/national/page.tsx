...
export default function NationalPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Title */}
      <div>
        <h1 className="text-shadow-3d">Politique Nationale</h1>
        <p className="text-brand-blue/70 mt-1">
          Analyse de la visibilité médiatique des {selectedCandidates.length} personnalités
          sélectionnées
        </p>
      </div>
        ...
        <Tabs defaultValue="scores" className="w-full">
          ...
          <TabsContent value="sentiment">
            {sentimentLoading ? (
              <div className="flex items-center justify-center h-32">
                <Loader2 className="w-6 h-6 animate-spin text-brand-pink" />
                <span className="ml-2 text-brand-blue/70">Analyse du sentiment en cours...</span>
              </div>
            ) : sentimentData ? (
              <div className="space-y-6">
                <Card>
          ...
          <TabsContent value="historique">
            <Card>
              ...
              <CardContent>
                <p className="text-brand-blue/50 text-center py-8">
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center gap-2">
                          ...
                          />
                          <span className={c.highlighted ? "font-bold text-brand-pink" : "font-medium"}>
                            {c.name}
                          </span>
                        </div>
                      ...
                      {c.press.topMedia && (
                        <p className="text-xs text-brand-blue/50">Top média: {c.press.topMedia}</p>
                      )}
                    ...
                    >
                      ...
                      <td className="py-3 px-2">
                        <div className="flex items-center gap-2">
                          ...
                          />
                          <span className={candidate.highlighted ? "font-bold text-brand-pink" : ""}>
                            {candidate.name}
                          </span>
                        </div>
                      </td>
